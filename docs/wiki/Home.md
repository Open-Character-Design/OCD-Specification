...
- **Reference**: [[Reference-Fields]] · [[Reference-Vocabularies]] · [[Reference-Diagnostics]]
- **Integration**: [[Validators]] · [[Integration-Node]] · [[Integration-Python]]
- **Examples**: [[Examples]]
...
Rendered documentation (GitHub Pages): `https://Open-Character-Design.github.io/OpenCharacter-Specification`
