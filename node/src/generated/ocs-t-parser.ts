...
function peg$parse(input, options) {
  ...
  var peg$e25 = peg$classExpectation(["e", "E"], false, false);
  ...
  var peg$e32 = peg$classExpectation([" ", "\t", "\f", "\v"], false, false);
  ...
  var peg$f0 = function(doc) { return doc; };
  var peg$f1 = function(headerBlock, body) {
      return {
        headers: headerBlock,
        body,
      };
    };
  var peg$f2 = function(first, rest, trailing) {
  ...
  var peg$f5 = function(head, tail, trailing) {
  ...
  var peg$f7 = function(elements) { return elements ?? []; };
  var peg$f8 = function(head, tail, trailing) {
      return [head, ...tail.map(([, element]) => element)];
    };
  var peg$f9 = function(value) { return value; };
  var peg$f10 = function(body) { return processTripleString(body); };
  var peg$f11 = function(chars) { return chars.join(''); };
  var peg$f12 = function(char) { return char; };
  ...
  var peg$f22 = function(digits) { return String.fromCharCode(parseInt(digits, 16)); };
  var peg$f23 = function(value) { return parseFloat(value); };
  ...
  function peg$parseHeaderLine() {
    var s0, s1, s2, s3, s4, s5, s6, s7, s8, s9;

    s0 = peg$currPos;
    s1 = peg$parseHeaderKey();
    if (s1 !== peg$FAILED) {
      s2 = peg$parseOptInlineWS();
      ...
      if (s3 !== peg$FAILED) {
        s4 = peg$parseOptInlineWS();
        s5 = peg$parseHeaderValue();
        if (s5 !== peg$FAILED) {
          s6 = peg$parseOptInlineWS();
          s7 = peg$parseComment();
          if (s7 === peg$FAILED) {
            s7 = null;
          }
  ...
  function peg$parseObjectMembers() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseObjectMember();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parseListSeparator();
      if (s4 !== peg$FAILED) {
        s5 = peg$parseObjectMember();
        if (s5 !== peg$FAILED) {
          s4 = [s4, s5];
          s3 = s4;
        } else {
  ...
  function peg$parseObjectMember() {
    var s0, s1, s2, s3, s4, s5;
  ...
  function peg$parseTripleStringBody() {
    var s0, s1, s2, s3, s4;
  ...
  function peg$parseOptInlineWS() {
    var s0;

    s0 = peg$parseInlineWS();
